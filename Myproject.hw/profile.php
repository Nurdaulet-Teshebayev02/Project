...
<section class="container page">
	<div class="page-content">
		<div class="notification">
			...
			?>
			<p>Welcome back, <?=$row['nickname']?> <img class="hand" src="https://web.telegram.org/z/img-apple-64/1f44b.png" alt=""></p>
	...
	<div class="page-info">
		<div class="user-profile">
			<img class="user-profile-ava" src="images/avatar2.png" alt="">
			<?php
				$id = $_SESSION['user_id'];
				$query_user = mysqli_query($con,
				"SELECT * FROM users WHERE
			...
			?>
			<h1><?=$row['full_name']?></h1>
			<p><?=mysqli_num_rows($query)?> постов за все время</p>
